...
tf.compat.v1.flags.DEFINE_integer("num_epochs",20, "Number of training epochs (default: 10)")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def train_step(x_batch, y_batch, learning_rate):
            ...
            with open(os.path.join(ROOT_DIR, "train/output/DUAL-optimizer.txt"), 'a') as f:
