...
def get_datasets_tobacco(path):
    ...
    for input_file in arr:
        ...
        # print("total line of ", input_file, " : ", total_lines, " select ", number_line_to_break, " lines from ", start_line_number_to_break, " to ", start_line_number_to_break+len(data))  #print lentgh of txt files in dataset after break
